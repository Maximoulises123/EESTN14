...
// Obtener comunicados ordenados por fecha (más recientes primero)
    ...
    <main>
        ...
        <?php if (isset($_SESSION['tipo']) && $_SESSION['tipo'] === 'admin'): ?>
            <div class="admin-section">
                <a href="publicar_comunicado.php">Publicar Comunicado</a>
            </div>
        <?php endif; ?>
                    ...
                    <div class="comunicado-item">
                        ...
                        <div class="comunicado-header">
                            <div class="titulo-fecha">
                                ...
                                <p class="fecha"><strong>Fecha:</strong> <?php echo date('d/m/Y', strtotime($comunicado['Fecha'])); ?></p>
                            </div>
