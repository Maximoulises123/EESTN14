...
// Obtener proyectos de precapacidades
$stmt = $pdo->query("SELECT * FROM proyectos WHERE categoria = 'precapacidades' AND activo = 1 ORDER BY destacado DESC, fecha_creacion DESC");
...
<head>
    ...
    <title>Pre Capacidades - EEST14</title>
    ...
    <main>
        <div class="page-container">
            <div class="page-header">
                ...
                <p>Proyectos introductorios que sientan las bases para el desarrollo de competencias técnicas</p>
            </div>
            
            <div class="section-intro">
                <h2>Fundamentos para el Desarrollo Técnico</h2>
                <p>Los proyectos de pre capacidades están diseñados para introducir a los estudiantes en los conceptos básicos y fundamentales de las diferentes especialidades técnicas. Estos proyectos proporcionan una base sólida que permite a los estudiantes comprender los principios esenciales antes de abordar proyectos más complejos.</p>
            </div>
            ...
            <?php if (empty($proyectos)): ?>
                <div class="empty-state">
                    ...
                    <p>Estamos trabajando en nuevos proyectos de pre capacidades. Los proyectos aparecerán aquí cuando estén disponibles.</p>
                </div>
            <?php else: ?>
                    ...
                    <?php foreach ($proyectos as $proyecto): ?>
                        <div class="proyecto-card <?php echo $proyecto['destacado'] ? 'destacado' : ''; ?>">
                            ...
                            <div class="proyecto-content">
                                <div class="categoria-badge">Pre Capacidades</div>
