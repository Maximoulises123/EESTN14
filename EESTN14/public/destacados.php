...
// Obtener proyectos destacados de todas las categorías
$stmt = $pdo->query("SELECT * FROM proyectos WHERE destacado = 1 AND activo = 1 ORDER BY fecha_creacion DESC");
...
<head>
    ...
    <title>Proyectos Destacados - EEST14</title>
    ...
    <main>
        <div class="page-container">
            <div class="page-header">
                ...
                <p>Los mejores proyectos que demuestran la excelencia de nuestros estudiantes</p>
            </div>
            
            <div class="section-intro">
                <h2>Excelencia en Acción</h2>
                <p>Los proyectos destacados representan el máximo nivel de excelencia en el trabajo de nuestros estudiantes. Estos proyectos han sido seleccionados por su calidad, innovación, impacto y capacidad de demostrar las competencias desarrolladas en nuestra institución.</p>
            </div>
            ...
            <?php if (empty($proyectos)): ?>
                <div class="empty-state">
                    ...
                    <p>Estamos trabajando en destacar los mejores proyectos. Los proyectos destacados aparecerán aquí cuando estén disponibles.</p>
                </div>
            <?php else: ?>
                    ...
                    <?php foreach ($proyectos as $proyecto): ?>
                        <div class="proyecto-card">
                            ...
                            <div class="proyecto-content">
                                <div class="categoria-badge"><?php echo ucfirst($proyecto['categoria']); ?></div>
