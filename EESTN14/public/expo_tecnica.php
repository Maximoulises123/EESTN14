...
// Obtener proyectos de expo-tecnica
$stmt = $pdo->query("SELECT * FROM proyectos WHERE categoria = 'expo-tecnica' AND activo = 1 ORDER BY destacado DESC, fecha_creacion DESC");
...
<head>
    ...
    <title>Expotécnica - EEST14</title>
    ...
    <main>
        <div class="page-container">
            <div class="page-header">
                ...
                <p>Exposición de proyectos técnicos que muestran el talento y la innovación de nuestros estudiantes</p>
            </div>
            ...
            <div class="evento-info">
                <h3>
                    ...
                    Evento Anual de Expotécnica
                </h3>
                <p>La Expotécnica es nuestro evento anual más importante donde los estudiantes exhiben sus mejores proyectos técnicos. Es una oportunidad única para mostrar al público el talento, la creatividad y la innovación que se desarrolla en nuestras aulas y talleres.</p>
            </div>
            
            <div class="section-intro">
                <h2>Innovación y Creatividad Técnica</h2>
                <p>Los proyectos de Expotécnica representan la culminación del aprendizaje técnico de nuestros estudiantes. Cada proyecto es una muestra de cómo los conocimientos teóricos se transforman en soluciones prácticas e innovadoras que pueden impactar positivamente en la sociedad.</p>
            </div>
            ...
            <?php if (empty($proyectos)): ?>
                <div class="empty-state">
                    ...
                    <p>Estamos preparando la próxima edición de Expotécnica. Los proyectos aparecerán aquí cuando estén disponibles.</p>
                </div>
            <?php else: ?>
                    ...
                    <?php foreach ($proyectos as $proyecto): ?>
                        <div class="proyecto-card <?php echo $proyecto['destacado'] ? 'destacado' : ''; ?>">
                            ...
                            <div class="proyecto-content">
                                <div class="categoria-badge">Expotécnica</div>
