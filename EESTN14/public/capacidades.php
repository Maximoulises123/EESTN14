...
// Obtener proyectos de capacidades
$stmt = $pdo->query("SELECT * FROM proyectos WHERE categoria = 'capacidades' AND activo = 1 ORDER BY destacado DESC, fecha_creacion DESC");
...
<head>
    ...
    <title>Capacidades - EEST14</title>
    ...
    <main>
        <div class="page-container">
            <div class="page-header">
                ...
                <p>Proyectos que desarrollan las competencias técnicas y profesionales de nuestros estudiantes</p>
            </div>
            
            <div class="section-intro">
                <h2>Desarrollo de Competencias Técnicas</h2>
                <p>Los proyectos de capacidades están diseñados para desarrollar las competencias técnicas específicas de cada especialidad. Estos proyectos permiten a los estudiantes aplicar conocimientos teóricos en situaciones reales, desarrollando habilidades prácticas y profesionales que los preparan para el mundo laboral.</p>
            </div>
            ...
            <?php if (empty($proyectos)): ?>
                <div class="empty-state">
                    ...
                    <p>Estamos trabajando en nuevos proyectos de capacidades. Los proyectos aparecerán aquí cuando estén disponibles.</p>
                </div>
            <?php else: ?>
                    ...
                    <?php foreach ($proyectos as $proyecto): ?>
                        <div class="proyecto-card <?php echo $proyecto['destacado'] ? 'destacado' : ''; ?>">
                            ...
                            <div class="proyecto-content">
                                <div class="categoria-badge">Capacidades</div>
