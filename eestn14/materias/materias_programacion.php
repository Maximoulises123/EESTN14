...
// Obtener materias de programación
$stmt = $pdo->query("
    SELECT * FROM materias 
    WHERE especialidad = 'Programacion' AND activa = 1 
...
<head>
    ...
    <title>Materias de Programación - EEST14</title>
    ...
    <main>
        <div class="container">
            <div class="header">
                ...
                <p>Plan de estudios del Ciclo Superior - Especialidad Programación</p>
            </div>
