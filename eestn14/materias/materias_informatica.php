...
$stmt = $pdo->query("
    ...
    WHERE especialidad = 'Informatica' AND activa = 1 
...
<head>
    ...
    <title>Materias de Informática - EEST14</title>
...
<body>
    ...
    <main>
        <div class="container">
            <div class="header">
                <h1>Técnico en Informática</h1>
                <p>Plan de estudios del Ciclo Superior - Especialidad Informática</p>
            </div>
